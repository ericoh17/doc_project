...
\mathbf{\psi} &\sim \text{N}(\psi_0 \cdot \mathbf{1}, \tau^2_{\psi} \cdot \mathbf{\Sigma}^{-1}) \\
\mathbf{\phi} &\sim \text{N}(\phi_0 \cdot \mathbf{1}, \tau^2_{\phi} \cdot \mathbf{\Sigma}^{-1}) \\
p(\psi_0) &\sim \text{N}(0, 1) \\
p(\phi_0) &\sim \text{N}(0, 1) \\
p(\tau^2_{\psi}) &\sim \text{N}(0, 1) \\
p(\tau^2_{\phi}) &\sim \text{N}(0, 1) \\
p(\rho) &\sim \text{Uniform}(0,1) \\
p(\mathbf{\beta}) &\sim \text{N}(0, \mathbf{I}) \\
p(\sigma^2_{\epsilon}) &\sim \text{N}(0, 1)
\end{align*}
$$
